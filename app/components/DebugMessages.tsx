...
const DebugMessages: React.FC<DebugMessagesProps> = ({ debugMessages }) => {
  ...
  // Only show debug messages if URL parameter is present
  const shouldShowDebug = typeof window !== 'undefined' && new URLSearchParams(window.location.search).get('showDebugToggle') === 'true';
